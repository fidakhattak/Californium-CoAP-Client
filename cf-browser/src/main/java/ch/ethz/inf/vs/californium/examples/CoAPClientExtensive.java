...
public class CoAPClientExtensive extends JPanel {
	...
	public CoAPClientExtensive() {
		...
		btnRemovePoll.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean success = removePoll((String) pollList
						.getSelectedValue());
				if (success)
					pollListModel.removeElement(pollList.getSelectedValue());
				else
